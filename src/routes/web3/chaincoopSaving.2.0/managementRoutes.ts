...
} from "../../../controllers/web3/chaincoopSaving.2.0/managementController";
import { authorize } from "../../../middlewares/authorization";
const router = Router();

/**
 * @swagger
 * /web3/v2/management/allow:
 *   post:
...
/**
 * @swagger
 * /web3/v2/management/feeCollection:
 *   post:
...
/**
 * @swagger
 * /web3/v2/management/changeOwnership:
 *   post:
