...
// const transferOwnership = async(newAdminAddress:string,adminPrivateKey:string)=>{
//     const con_tract = await chainCoopSavingcontract(adminPrivateKey);
...
// const setAddressForFeeCollection = async(newFeeAddress:string,adminPrivateKey:string)=>{
//      const con_tract = await chainCoopSavingcontract(adminPrivateKey);
...
// }
// const flagRemoveTokens=async(tokenAddress:string,adminPrivateKey:string)=>{
//     const con_tract = await chainCoopSavingcontract(adminPrivateKey);
...
// export {addSupportedTokenAddress,transferOwnership,flagRemoveTokens,setAddressForFeeCollection}